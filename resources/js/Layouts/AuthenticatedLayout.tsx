        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    href: isAdmin ? route('admin.leaves.index') : route('leaves.index'),
                ...
                },
                {
                    ...
                    href: isAdmin ? route('admin.overtimes.index') : route('overtimes.index'),
                ...
                },
                {
                    ...
                    href: route().has(isAdmin ? 'admin.shift-exchanges.index' : 'shift-exchanges.index')
                        ? route(isAdmin ? 'admin.shift-exchanges.index' : 'shift-exchanges.index')
                        : '#',
                    active: (route().has('shift-exchanges.index') && route().current('shift-exchanges.*')) || 
            ...
            {permissionsGranted === false && (
                <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center p-4 bg-slate-950/80 dark:bg-slate-950/90 backdrop-blur-md text-white">
                    <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl text-slate-800 dark:text-white border border-slate-100 dark:border-slate-700/50 text-center flex flex-col items-center space-y-6 animate-bounce-in">
                        ...
                        <div className="w-full space-y-4 bg-slate-50 dark:bg-slate-900/50 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 text-left">
                            {/* NOTIFICATION ITEM */}
